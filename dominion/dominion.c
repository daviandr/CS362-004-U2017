...
int playSmithy(int currentPlayer, struct gameState *state){
     //+3 Cards
      for (i = 0; i < 10; i++)
	{
	  drawCard(currentPlayer, state);
...
int playAdventurer(int currentPlayer, int hadPos, struct gameState* state){
...
int playVillage(int currentPlayer, int hadPos, struct gameState* state){
      //+1 Card
      drawCard(currentPlayer, state);
...
int playMine(int currentPlayer, int hadPos, int choice1, int choice2, struct gameState* state){
      j = state->hand[currentPlayer][choice1];  //store card we will trash
